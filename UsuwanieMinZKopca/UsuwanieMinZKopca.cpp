...
void kopiec1(int arr[], int n, int i)
{
...
void kopiec2(int arr2[], int n, int i)
{
    int najwiekszy = i; // Inicjalizacja korzenia
...
void pop(int arr[], int arr2[], int n)
{
...
int main()
{
    ...
    cout << "Oto losowe 20 elementow tablicy: ";
    srand(time(NULL));
    for (i = 0; i < 20; i++)
    {
        v = rand() % 100;
    ...
    cout << "Kopiec po zamianie korzenia z najmniejsza wartoscia kopca: " << endl;
    for (int i = 0; i < 20; ++i)
    {
        cout << arr[i] << " ";
    }
